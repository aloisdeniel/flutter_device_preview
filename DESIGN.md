...
```json
{
  ...
  "systemUi": {"statusBar": {"inset": 30.0, "leading": "<svg …>", "trailing": "<svg …>"},
               "navigationBar": {"center": "<svg …>", "bottomInset": 8.0}},
  "showSystemUi": false,
  "pointerKind": "touch",
