...
class DevicePreset {
  const DevicePreset({
    ...
    this.brand,                        // 'Apple'
    this.year,                         // release year, e.g. 2025
...
abstract final class DevicePresets {
  ...
  static const DevicePreset iPhone17e = ...;
