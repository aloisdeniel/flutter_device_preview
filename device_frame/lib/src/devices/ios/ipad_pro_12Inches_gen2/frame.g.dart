...
class _FramePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_2_fill.color = Color(0xff262C2D).withAlpha((1.0 * 255).round());
    ...
    paint_3_fill.color = Color(0xff262C2D).withAlpha((1.0 * 255).round());
    ...
    paint_5_fill.color = Color(0xff636F73).withAlpha((1.0 * 255).round());
